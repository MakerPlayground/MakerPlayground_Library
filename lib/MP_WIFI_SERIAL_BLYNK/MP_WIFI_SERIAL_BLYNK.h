#ifndef MP_WIFI_SERIAL_BLYNK_H
#define MP_WIFI_SERIAL_BLYNK_H

#include <Arduino.h>
#include <SoftwareSerial.h>
#include <ESP8266_Lib.h>

class MP_WIFI_SERIAL_BLYNK
{
public:
	MP_WIFI_SERIAL_BLYNK(uint8_t rx, uint8_t tx, char auth[], char ssid[], char pass[]);
